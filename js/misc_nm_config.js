...
function PageInit(){
    ...
    var chkTimer1 = document.getElementById("_nm_toggle_timer1");
    var chkTimer2 = document.getElementById("_nm_toggle_timer2");
    var chkTimer3 = document.getElementById("_nm_toggle_timer3");
    var chkTimer4 = document.getElementById("_nm_toggle_timer4");
    var chkTimer5 = document.getElementById("_nm_toggle_timer5");
    ...
    var nmPolicyNum = document.getElementById("_nm_policy_number");
    nmPolicyNum.addEventListener("keypress", validateNumeric);
    nmPolicyNum.addEventListener("keydown", validateNumeric);

    var nmPwrlimit = document.getElementById("_nm_power_limit");
    ...
    var del_user = document.getElementById("btn_del");
