...
function checkLaunchSolBtn() {
    open_SOL_new_windown = document.getElementById("openSOLNewWindow");
    open_SOL_new_windown.textContent = lang.LANG_CONFIG_SOL_NEW_WINDOW;
    open_SOL_new_windown.disabled = false;
    window.onbeforeunload = function () {
        open_SOL_new_windown.disabled = false;
    };
    open_SOL_new_windown.addEventListener("click", launchSOL);
    if (getUrlParam("openNewWindowVariable") == 1) {
        open_SOL_new_windown.show();
...
function launchSOL() {
    ...
    open_SOL_new_windown.disabled = true;
