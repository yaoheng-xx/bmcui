...
function displaySysComp() {
  ...
  if(Chassis_count > 0){
    ...
    for(let i=0; i<Chassis_count; i++)
    {
        ...
        document.getElementById("Type_" + "Chassis" + i).textContent = ChassisDevice[i].ChassisType;
    }
  ...
  if (PSU_count > 0) {
    ...
    for(let i=0; i<PSU_count; i++)
    {
        ...
        document.getElementById("Type_" + "PSU" + i).textContent = PSUDevice[i].ChassisType;
    }
  ...
  if (Riser_count > 0) {
    ...
    for(let i=0; i<Riser_count; i++)
    {
        ...
        document.getElementById("Type_" + "Riser" + i).textContent = RiserDevice[i].ChassisType;
    }
  ...
  if (HSBP_count > 0) {
    ...
    for(let i=0; i<HSBP_count; i++)
    {
        ...
        document.getElementById("Type_" + "HSBP" + i).textContent = HSBPDevice[i].ChassisType;
    }
  ...
  if (Misc_count > 0) {
    ...
    for(let i=0; i<Misc_count; i++)
    {
        ...
        document.getElementById("Type_" + "Misc" + i).textContent = MiscDevice[i].ChassisType;
    }
...
function setBBInnerHtml(elementName, devName) {
  ...
  // Type
  "<tr><td align=\"right\" class=\"bold\">" +
  "<label class=\"labeltitle\">" + lang.LANG_SYS_COMPONENT_TYPE +
  "</label></td>" +
  "<td><span id=\"Type_" + elementName + "\"" +
  " class=\"labeltext\"></span>" +
  "</td></tr>" +
  "</table>" +
  "</fieldset>" +
...
function ReplyFRUInfo(arg) {
  if (arg.readyState == 4 && arg.status == 200) {
    ...
    } else if (device_name.includes("RISER")) {
